...
describe('AppComponent', () => {
  ...
  describe('Angular-Aware test', () => {
    ...
    it('should load stock with default values', () => {
      ...
      expect(titleEl.nativeElement.textContent.trim()).toEqual("Welcome to Sophia's stock market !");

      // Check for default stock values in template
      const nameEl = fixture.debugElement.query(By.css('.name'));
      expect(nameEl.nativeElement.textContent.trim()).toEqual('Test Stock Company (TSC)');//trim
    ...
    it('should toggle stock favorite correctly', () => {
      expect(component.stockObj.favorite).toBeFalsy();//stockObj
